...
//    @Binding var vm.show : Bool
    var height = (UIScreen.main.bounds.height)/3
     var podcast :EpoisdesModel
...
//        .opacity(podcast.artistName == nil ? 0 : 1)
...
//    }
    ...
    func playAudio()  {
//        guard let url = URL.init(string: podcast.) else { return }
